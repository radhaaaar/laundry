...
include 'koneksi.php';
session_start();
$tampilLevel = mysqli_query($koneksi, "SELECT * FROM paket");
...
if (isset($_POST['edit'])) {
    ...
    $update = mysqli_query($koneksi, "UPDATE paket SET nama_level='$nama_level', harga='$harga', deskripsi='$deskripsi' WHERE id='$id'");
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input value=" <?php echo isset($_GET['edit']) ? $rowEdit['nama_paket'] : '' ?>" class="form-control" type="text" name="nama_paket" placeholder="nama paket?">
                                                </div>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-6">
                                                        <label class="form-label" for=""> harga</label>
                                                        <input value=" <?php echo isset($_GET['edit']) ? $rowEdit['harga'] : '' ?>" class="form-control" type="text" name="harga" placeholder="nama harga?">
                                                    </div>
                                                    <div class="mb-3 row">
                                                        <div class="col-sm-6">
                                                            <label class="form-label" for="">deskripsi</label>
                                                            <input value=" <?php echo isset($_GET['edit']) ? $rowEdit['deskripsi'] : '' ?>" class="form-control" type="text" name="deskripsi" placeholder="nama deskripsi?">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">

...
if (isset($_POST['simpan'])) {
  ...
  // } else
  {
    $sql = "INSERT INTO user (nama,email,password,username,id_level) VALUES ('$nama','$email','$password','username','$id_level')";
    $result = mysqli_query($koneksi, $sql);
  }
  if ($result) {
                      ...
                      <div class="mb-3 row">
                        <div class="col-sm-6">
                          ...
                          <select name="id_level" id="" class="form-control">
                            ...
                            <?php while ($row = mysqli_fetch_assoc($tampilLevel)): ?>
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" name="username" id="" placeholder="Masukan Nama anda" value="<?php echo isset($_GET['edit']) ? $rowEdit['username'] : '' ?>" required>
                        </div>
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" name="username" id="" placeholder="Masukan username anda">
                        </div>
                        <div class="col-sm-6">

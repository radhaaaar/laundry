...
$queryLevel = mysqli_query($koneksi, "SELECT * FROM  paket ORDER BY id DESC");
...
if (isset($_GET['delete'])) {
    ...
    header("Location:paket.php?login=berhasil");
}
?>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table">
                                            <table class="table table-responsive table-bordered">
                                                ...
                                                <tbody>
                                                    <?php $no = 1;
                                                    while ($rowPaket = mysqli_fetch_assoc($queryLevel)) { ?>
                                                        <tr>
                                                            <td><?php echo $no++ ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a onclick="return confirm('Apakah antum yakin akan menghapus data ini??')" href="paket.php?delete=<?php echo $rowCustomer['id'] ?>">

...
if (isset($_POST['simpan'])) {
    ...
    // } else
    {
        $sql = "INSERT INTO level (nama_level) VALUES ('$nama_level')";
        $result = mysqli_query($koneksi, $sql);
    }
    if ($result) {
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input value=" <?php echo isset($id) ? $rowEdit['nama_level'] : '' ?>" class="form-control" type="text" name="nama_level" placeholder="nama level?">

...
$queryUser = mysqli_query($koneksi, "SELECT customer.customer_name, trans_order.* FROM trans_order
 LEFT JOIN customer ON trans_order.id_customer = customer.id ORDER BY id DESC");
                                                    ...
                                                    while ($rowTrans = mysqli_fetch_assoc($queryUser)) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a onclick="return confirm('Apakah antum yakin akan menghapus data ini??')" href="trans_order.php?delete=<?php echo $rowTrans['id'] ?>">
